    ...
    return (
        <div className="bg-[url('https://i.imgur.com/OTXEdIB.png')] bg-center bg-no-repeat bg-cover justify-items-center">
            ...
            <section className="sendConditions flex flex-row justify-evenly gap-6 px-14 py-12" >
                <a className="shippingTable flex flex-col justify-center items-center p-6 gap-4 bg-white border-solid shadow rounded-lg w-[316px] h-[232px] text-center">
                ...
                <a className="shippingCar flex flex-col justify-center items-center p-6 gap-4 bg-white border-solid shadow rounded-lg w-80 text-center">
                ...
                <a className="giftDiscounts flex flex-col justify-center items-center p-6 gap-4 bg-white border-solid shadow rounded-lg w-80 text-center">
